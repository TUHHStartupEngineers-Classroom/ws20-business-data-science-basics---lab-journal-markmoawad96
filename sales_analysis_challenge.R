...
write_xlsx("DS_101/00_data/01_bike_sales/02_wrangled_data/bike_orderlines_challenge.xlsx")

# 6.2 CSV ----
bike_orderlines_wrangled_tbl %>% 
write_csv("DS_101/00_data/01_bike_sales/02_wrangled_data/bike_orderlines_challenge.csv")

# 6.3 RDS ----
bike_orderlines_wrangled_tbl %>% 
write_rds("DS_101/00_data/01_bike_sales/02_wrangled_data/bike_orderlines_challenge.rds")